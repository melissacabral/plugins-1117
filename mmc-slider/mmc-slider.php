 ...
 */
function mmc_slider_scripts(){
	$css_url = plugins_url( 'css/mmc-slider.css', __FILE__ );
	wp_enqueue_style( 'mmc-slider-style', $css_url );
	...
	$custom_url = plugins_url( 'js/mmc-slider.js', __FILE__ );
	wp_enqueue_script('mmc-slider-js', $custom_url, array( 'jquery', 'responsiveslides' ),
	 '0.1', true );
	
}
add_action( 'wp_enqueue_scripts', 'mmc_slider_scripts' );
